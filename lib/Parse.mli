...
(**
    Functions for parsing elixir programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a elixir program from a string into a typed OCaml CST.
...
(** Parse a elixir program from a file into a typed OCaml CST.
