...
type imm_tok_pat_b250293 = Token.t (* pattern [A-Z][A-Z0-9]* *)
...
and atom = [
  ...
  | `Meta_atom of (Token.t (* ":" *) * semgrep_metavariable (*tok*))
]
...
and expression = [
  ...
  | `Sigil of (
      ...
      * [
          ...
          | `Imm_tok_pat_b250293_choice_quoted_double of (
                imm_tok_pat_b250293
              * [
  ...
  | `Anon_func of (
        Token.t (* "fn" *)
      * terminator option
      * (stab_clause * (terminator * stab_clause) list (* zero or more *))
          option
      * Token.t (* "end" *)
    )
  | `Deep_ellips of (
...
and keyword = [
  ...
  | `Meta_kw of (semgrep_metavariable (*tok*) * pat_5eb9c21)
]
...
type metavariable_atom (* inlined *) = (
    Token.t (* ":" *) * semgrep_metavariable (*tok*)
)

type metavariable_keyword (* inlined *) = (
    semgrep_metavariable (*tok*) * pat_5eb9c21
)
...
type anonymous_function (* inlined *) = (
    Token.t (* "fn" *)
  * terminator option
  * (stab_clause * (terminator * stab_clause) list (* zero or more *)) option
  * Token.t (* "end" *)
)
